...
export default class HomeOther extends React.Component {
  ...
  getData = () => {
    ...
    fetch(`http://10.0.2.2:3000/app/api/list/news/other/category=${category}&page=${page}`)
   ...
   let docid = item._id
    ...
    return (
      ...
      <View style={styles.item}>
        <TouchableOpacity onPress={() => { this.props.navigation.navigate('newsDetail', {docid}); }}>
